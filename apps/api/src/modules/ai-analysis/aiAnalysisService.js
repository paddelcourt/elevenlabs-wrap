...

{
  ...
  "musicPrompts": [
    ...
    "  * USE VOCALS for: pop, hip-hop, rap, R&B, soul, rock, indie rock, punk, country, folk, singer-songwriter",
    "  * USE INSTRUMENTAL for: electronic, EDM, ambient, classical, jazz, lo-fi, chillwave, vaporwave, soundtrack, study music",
    "  * MIX BOTH if their taste spans multiple genres",
    ...
    "",
    "Prompt Templates:",
    "VOCAL: \"[Mood] [genre] track at [BPM] with [male/female/androgynous] vocals, featuring [instruments]. The vocals should be [singing style] and the music should feel [adjectives]. Suitable for [use case]. Include [musical elements].\"",
    "INSTRUMENTAL: \"[Mood] [genre] instrumental track at [BPM], featuring [instruments], in the style of [era/influence]. The music should feel [adjectives] and be suitable for [use case]. Include [musical elements].\"",
    "",
    "Example Vocal Track:",
    "{ \"title\": \"Midnight Drive\", \"prompt\": \"Melancholic indie pop track at 95 BPM with smooth male vocals, featuring acoustic guitar and subtle synths. The vocals should be intimate and emotional and the music should feel nostalgic and introspective. Suitable for late-night reflection. Include gentle dynamics and a memorable chorus.\" }",
    "",
    ...
    "Vocal Styles: smooth, raspy, powerful, soft, emotive, rhythmic, melodic",
    "Use Cases: workout, study, gaming, relaxation, driving, focus, meditation, cooking, singing along"
  ]
}
